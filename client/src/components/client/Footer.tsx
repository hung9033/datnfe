...
import yourImage from "../../public/images/modern-den.png";
const Footer = () => {
    return (
            ...
            <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        <li>
                            <p>📍 Hà Nội</p>
                            <p>112 Xã Đàn, Quận Đống Đa</p>
                            <p>📞 0792 102 777</p>
                        </li>
                        <li>
                            <p>📍 Hồ Chí Minh</p>
                            <p>216A Hồ Văn Huê, Quận Phú Nhuận</p>
                            <p>📞 0898 426 314</p>
                        </li>
                        <li>
                            <p>✉️ <a href="mailto:hello@frcnk.com" className="hover:underline">hello@frcnk.com</a></p>
                        </li>
                    </ul>
                    {/* Mạng xã hội */}
